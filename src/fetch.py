...
#        s1 = "curl http://api.metagenomics.anl.gov/sequenceset/mgm%s-050-1/                    > %s.gz"  % ( a, a )
        s1 = "curl http://api.metagenomics.anl.gov/1/download/mgm%s?file=050.2/                 > %s.fas"  % ( a, a )
...
#        s1 = "curl 'http://api.metagenomics.anl.gov/sequenceset/mgm%s-050-1/?&auth=%s'  > %s.gz" % ( a, key, a )
        s1 = "curl 'http://api.metagenomics.anl.gov/1/download/mgm%s?file=050.2&auth=%s'  > %s.fas" % ( a, key, a )
